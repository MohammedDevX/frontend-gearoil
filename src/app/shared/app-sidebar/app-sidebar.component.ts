...
import { Component, ElementRef, QueryList, ViewChildren, ChangeDetectorRef, Inject, PLATFORM_ID } from '@angular/core';
...
export class AppSidebarComponent {
  ...
  allNavItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM3.5 12C3.5 7.30558 7.30558 3.5 12 3.5C14.1526 3.5 16.1184 4.3002 17.616 5.61936C15.3096 6.17279 13.5955 8.24852 13.5955 10.7246V13.2746C13.5955 15.7509 15.31 17.8268 17.6167 18.38C16.119 19.6996 14.153 20.5 12 20.5C7.30558 20.5 3.5 16.6944 3.5 12ZM18.8566 17.0246C18.8455 17.0246 16.7744 15.3457 15.0955 13.2746V10.7246C15.0955 8.65354 16.7744 6.97461 18.8455 6.97461C19.8895 8.38223 20.5 10.1198 20.5 12C20.5 13.8798 19.8898 15.6171 18.8566 17.0246ZM12 5.75C10.0563 5.75 8.48126 7.32499 8.48126 9.26784C8.48126 11.2107 10.0563 12.7857 12 12.7857C13.9419 12.7857 15.5169 11.2107 15.5169 9.26784C15.5169 7.32499 13.9419 5.75 12 5.75ZM9.98126 9.26784C9.98126 8.15342 10.8847 7.25 11.9991 7.25C13.1135 7.25 14.0169 8.15342 14.0169 9.26784C14.0169 10.3823 13.1135 11.2857 11.9991 11.2857C10.8847 11.2857 9.98126 10.3823 9.98126 9.26784Z" fill="currentColor"></path></svg>`,
      name: "Suppliers",
      path: "/admin/suppliers",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 8L12 3L3 8V18L12 21L21 18V8ZM19.2 17.5L12 20.3L4.8 17.5V8.5L12 11.3L19.2 8.5V17.5ZM12 9.5L5.7 6.1L12 4.1L18.3 6.1L12 9.5Z" fill="currentColor"/></svg>`,
      name: "Products",
      path: "/admin/products",
    },
    {
  ...
  ngOnInit() {
    ...
    if (this.userRole === 'Admin') {
      ...
      this.othersItems = this.allOthersItems;
    } else if (this.userRole === 'Livreur') {
      this.navItems = [
        {
          icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V8.99998C3.25 10.2426 4.25736 11.25 5.5 11.25H9C10.2426 11.25 11.25 10.2426 11.25 8.99998V5.5C11.25 4.25736 10.2426 3.25 9 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H9C9.41421 4.75 9.75 5.08579 9.75 5.5V8.99998C9.75 9.41419 9.41421 9.74998 9 9.74998H5.5C5.08579 9.74998 4.75 9.41419 4.75 8.99998V5.5ZM5.5 12.75C4.25736 12.75 3.25 13.7574 3.25 15V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H9C10.2426 20.75 11.25 19.7427 11.25 18.5V15C11.25 13.7574 10.2426 12.75 9 12.75H5.5ZM4.75 15C4.75 14.5858 5.08579 14.25 5.5 14.25H9C9.41421 14.25 9.75 14.5858 9.75 15V18.5C9.75 18.9142 9.41421 19.25 9 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V15ZM12.75 5.5C12.75 4.25736 13.7574 3.25 15 3.25H18.5C19.7426 3.25 20.75 4.25736 20.75 5.5V8.99998C20.75 10.2426 19.7426 11.25 18.5 11.25H15C13.7574 11.25 12.75 10.2426 12.75 8.99998V5.5ZM15 4.75C14.5858 4.75 14.25 5.08579 14.25 5.5V8.99998C14.25 9.41419 14.5858 9.74998 15 9.74998H18.5C18.9142 9.74998 19.25 9.41419 19.25 8.99998V5.5C19.25 5.08579 18.9142 4.75 18.5 4.75H15ZM15 12.75C13.7574 12.75 12.75 13.7574 12.75 15V18.5C12.75 19.7426 13.7574 20.75 15 20.75H18.5C19.7426 20.75 20.75 19.7427 20.75 18.5V15C20.75 13.7574 19.7426 12.75 18.5 12.75H15ZM14.25 15C14.25 14.5858 14.5858 14.25 15 14.25H18.5C18.9142 14.25 19.25 14.5858 19.25 15V18.5C19.25 18.9142 18.9142 19.25 18.5 19.25H15C14.5858 19.25 14.25 18.9142 14.25 18.5V15Z" fill="currentColor"></path></svg>`,
    ...
    // Subscribe to combined observables to manage collapsed state
    this.subscription.add(
      combineLatest([this.isExpanded$, this.isMobileOpen$, this.isHovered$]).subscribe(
        ([isExpanded, isMobileOpen, isHovered]) => {
          this.isCollapsed = !isExpanded && !isMobileOpen && !isHovered;
